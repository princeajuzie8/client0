...
<nav className={`mean-nav ${menuOpens ? 'toggle' : ''}`}>
    <nav>
      ...
      >
       ...
       {/*services */}
       <section
        className="bg-[#333333]  h-[fit-content] flex  items-center justify-center  px-[40px] pt-[30px] pb-[0px]"
        id="services"
      >
      ...
      {/*Resume*/}
      <section
        className="bg-[#312f2f]   h-[100vh-10px] w-[auto] relative justify-center pt-[20px] pt-[30px]"
        id="resume"
      >
      ...
      <div className="flex flex-row   justify-center  gap-[30px] pt-20 px-[40px] tabletmin:flex-none tabletmin:grid tabletmin:grid-cols-2 tabletmin:gap-[20px] tabletmin:px-[20px] small:px-[15px]  small:grid-cols-1">
        ...
        <div className="col-lg-3 col-md-6 w-[300px]">
          <div className="footer-widget-single">
            <h3>Our Services</h3>
            <ul>
              <li><Link to="#home">Photography</Link></li>
              <li><Link to="#about">Web Design</Link></li>
              <li><Link to="#">Woocommerce</Link></li>
              <li><Link to="#">Brand Image</Link></li>
            </ul>
          </div>
        </div>
        <div className="col-lg-3 col-md-6 w-[300px]">
          <div className="footer-widget-single">
            ...
            <li>
                  <Link to="https://www.facebook.com/profile.php?id=100090268895002">
                    <div className="w-[40px] h-[40px] flex justify-center items-center rounded-full bg-[#163d4d] hover:bg-[#1b7599] text-white text-base transition-all duration-300 ease-in-out">
                      <BiLogoFacebook />
                    </div>
                  </Link>
                </li>
                <li>
                  <Link to="https://twitter.com/__Mmesoma__">
                    <div className="w-[40px] h-[40px] flex justify-center items-center rounded-full bg-[#163d4d] hover:bg-[#1b7599] text-white text-base transition-all duration-300 ease-in-out">
                      {" "}
                      <BiLogoTwitter />
                    </div>
                ...
                <li>
                  <Link to="https://www.instagram.com/okanume_precious/">
                    <div className="w-[40px] h-[40px] flex justify-center items-center rounded-full bg-[#163d4d] hover:bg-[#1b7599] text-white text-base transition-all duration-300 ease-in-out">
                      <BiLogoInstagram />
                    </div>
                  </Link>
                ...
                <li>
                  <Link to="https://www.linkedin.com/in/precious-okanume-48117226a/">
                    <div className="w-[40px] h-[40px] flex justify-center items-center rounded-full bg-[#163d4d] hover:bg-[#1b7599] text-white text-base transition-all duration-300 ease-in-out">
                      {" "}
                      <BiLogoLinkedin />
                    </div>
